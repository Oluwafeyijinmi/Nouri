...
export const MENU_ITEMS: MenuItem[] = [
  // --- RICE DISHES ---
  {
    ...
    nutrition: 'Calories: 450kcal | Protein: 22g | Carbs: 65g | Fat: 12g | Key Ingredients: Parboiled Rice, Lean Beef, Tomatoes, Red Peppers, Onion, Native Spices', category: 'rice',
    price: 3000,
  ...
  // --- SWALLOW DISHES ---
  {
    ...
    nutrition: 'Calories: 380kcal | Protein: 18g | Carbs: 55g | Fat: 10g | Key Ingredients: Cassava Flakes, Jute Leaves, Locust Beans, Assorted Meat', category: 'swallow',
    price: 2500,
  ...
  // --- SOUPS IN LITRES / BOWLS ---
  {
    ...
    nutrition: 'Calories: 520kcal | Protein: 35g | Carbs: 15g | Fat: 32g | Key Ingredients: Melon Seeds, Palm Oil, Spinach, Crayfish, Dry Fish', category: 'soup',
  ...
  // --- SNACKS ---
  {
    ...
    nutrition: 'Calories: 210kcal | Protein: 5g | Carbs: 30g | Fat: 8g | Key Ingredients: Wheat Flour, Margarine, Sugar, Nutmeg', category: 'snack',
    price: 800,
    sizes: [
